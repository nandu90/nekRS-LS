...
#define nekrsCheck(_nekrsCheckCond, _nekrsCheckComm, _nekrsCheckExitCode, _nekrsCheckMessage, ...)           \
do {                                                                                                         \
...
fprintf(stderr, _nekrsCheckMessage, __VA_ARGS__);                                                            \
print_stacktrace();                                                                                          \
}                                                                                                            \
fflush(stderr);                                                                                              \
fflush(stdout);                                                                                              \
MPI_Barrier(_nekrsCheckComm);                                                                                \
MPI_Abort(MPI_COMM_WORLD, _nekrsCheckExitCode);                                                              \
}                                                                                                            \
} while (0)
