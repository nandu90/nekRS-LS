...
{
public:
  static constexpr int CODE_INTERNAL = findpts::CODE_INTERNAL;
  static constexpr int CODE_BORDER = findpts::CODE_BORDER;
  static constexpr int CODE_NOT_FOUND = findpts::CODE_NOT_FOUND;
